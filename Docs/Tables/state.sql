...
ALTER TABLE `state`
  ADD PRIMARY KEY (`id`),
  ADD KEY `state_country_id_6b36f831_fk_country_id` (`country_id`);
...
--
ALTER TABLE `state`
  ADD CONSTRAINT `state_country_id_6b36f831_fk_country_id` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`);
COMMIT;
